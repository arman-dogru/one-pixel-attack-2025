...
if __name__ == "__main__":
    ...
    def predict_classes(xs, img, target_class, model, minimize=True):
        ...
        imgs_perturbed = helper.perturb_image(xs, img) # Shape: (population_size, 32, 32, 3)
        ...
        predictions = predictions if minimize else 1 - predictions # Confidence should go down
